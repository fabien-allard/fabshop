...
<body>
    ...
    <section class="index">
        ...
        <a href="#" class="navbar-brand d-flex align-items-center">
            ...
            <li><a href="profil.php" class="nav-link px-2 text-white">Profils</a></li>
            ...
            <div class="text-end">
            <a href="connexion.php"><button type="button" class="btn btn-outline-light me-2">Connexion</button></a>
    ...
    <section class="py-5 text-center container">
        ...
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Paiement Paypal</h1>
